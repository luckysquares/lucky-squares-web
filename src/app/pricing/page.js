        ...
        <div className="section-inner">
          <div className="pricing-grid" style={{ maxWidth: 900, margin: '0 auto' }}>
            <div className="pricing-card">
              ...
              <Link href="/get-started" className="btn btn-outline" style={{ width: '100%', justifyContent: 'center' }}>
            ...
            <div className="pricing-card featured">
              ...
              <Link href="/get-started" className="btn btn-purple" style={{ width: '100%', justifyContent: 'center' }}>
          ...
          <div style={{ marginTop: 48, background: 'linear-gradient(135deg, #6B46F5 0%, #a855f7 100%)', borderRadius: 16, padding: '28px 36px', maxWidth: 700, margin: '48px auto 0', display: 'flex', alignItems: 'center', gap: 20, flexWrap: 'wrap', color: '#fff' }}>
            ...
            <div style={{ flex: 1, minWidth: 220 }}>
              ...
              <div style={{ fontSize: 13, opacity: 0.85, lineHeight: 1.6 }}>
                Register and complete your first Lucky Squares campaign for free. No $19 launch fee. You will earn a permanent Foundation Member badge and go in the draw for a $150 voucher.
              </div>
            </div>
          ...
          <div style={{ marginTop: 64, background: '#fff', border: '1.5px solid var(--border)', borderRadius: 16, padding: '32px 40px', maxWidth: 700, margin: '48px auto 0' }}>
